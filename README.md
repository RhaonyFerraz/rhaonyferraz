...
<a href="https://github.com/RhaonyFerraz">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0070F2,100:00B4D8&height=180&section=header&text=Rhaony%20Ferraz&fontSize=42&fontColor=ffffff&desc=Cientista%20de%20Dados%20%7C%20Desenvolvedor%20SAP%20BTP%20%26%20ABAP%20Cloud&descSize=17&descAlignY=66&animation=fadeIn" width="100%"/>
</a>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=00B4D8&center=true&vCenter=true&width=600&lines=SAP+BTP+%26+ABAP+Cloud+Developer;Data+Scientist+%7C+Clean+Core+Specialist;OData+V4+%7C+RAP+%7C+SAP+HANA;Transformando+dados+em+valor+real+%F0%9F%9A%80)](https://git.io/typing-svg)
...
Bacharel em **Ciência de Dados** atuando na modernização de arquiteturas transacionais e analíticas no ecossistema SAP. Especialista em estratégias **Clean Core**, desenvolvimento **ABAP Cloud**, modelagem em **SAP HANA** e integração em nuvem no **SAP BTP** (*Business Technology Platform*).
...
- **[SAP BTP — Portal de Logística & Estoque RF](https://github.com/RhaonyFerraz/sap-portal-estoque)**  
  Solução de borda que otimiza custos com licenças SAP ERP (~US$ 82.200/ano para 50 operadores). Integração via OData V4 com SAP HANA, Service Binding RAP, fila offline com auto-sync e decodificador GS1-128 / DataMatrix.  
  *Aplicação no ar:* [rhaonyferraz.github.io/sap-portal-estoque](https://rhaonyferraz.github.io/sap-portal-estoque/)

- **[Carga & Validação de Clientes via Excel (ABAP Cloud)](https://github.com/RhaonyFerraz/cadastro-excel-abap)**  
  Processamento de dados mestres em massa em ABAP Cloud, validação algorítmica de CNPJ (Módulo 11) e consumo com CDS View Entities para SAP Fiori Elements.

---

<div align="center">

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00B4D8,100:0070F2&height=100&section=footer" width="100%"/>
